...
const milestones = [
  { year: "2004", title: "Founded", desc: "Magnify Services Inc was established with a vision to transform adult foster care." },, title: "Founded", desc: "Magnify Services Inc was established with a vision to transform adult foster care." }, with a vision to transform adult foster care." },
